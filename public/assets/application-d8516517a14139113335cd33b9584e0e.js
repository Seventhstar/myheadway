...
(function() {
  ...
  this.sortable_query = function(params) {
    var actual, controller, l, method, p, p_params, url;
    ...
    method = $('#cur_method').val() === 'edit_multiple' ? '/edit_multiple' : '';
...
(function() {
  $(document).ready(function() {
    ...
    $('#search').on('keyup', function() {
      return $.get('statements', $("#statements_search").serialize(), null, 'script');
    });
    $('#tag_id').chosen().on('change', function() {
      return $.get('statements', $("#statements_search").serialize(), null, 'script');
    });
    $('#author_id').chosen().on('change', function() {
      return $.get('statements', $("#statements_search").serialize(), null, 'script');
    });
...
/*$('#key1').removeClass('simple-navigation-active-leaf');*/
  ...
  $('span.calenday').click(function(){
     ...
     if ($(this).hasClass("checked")){
        ...
        checked = true;
        $(this).addClass("checked");
        //$(this).switchClass( "", "checked", 100, "easeInOutQuad" );
     };
  ...
  /*$('.target_li, .t-item').hover(function(){
    $(this).find("div.edit_delete").toggleClass('hidden');
   }
  );*/
