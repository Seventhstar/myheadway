...
(function() {
  ...
  this.ajx2q = function(qa) {
    ...
    for (key in qa) {
      if (qa[key] === null || qa[key] === void 0 || qa[key] === '' || key === 'utf8' || key === 'authenticity_token' || key === '_' || isFunction(qa[key])) {
        continue;
      }
      if (isArray(qa[key])) {
        i = 0;
...
(function() {
  ...
  $(document).ready(function() {
    ...
    return $(document).on('click', ' span.icon_remove', function() {
      ...
      if (url.indexOf('edit') < 1 && url.indexOf('options') < 1 && url.indexOf('tasks') < 1) {
        url = url + '/edit';
      }
