...
class DocsControllerTest < ActionController::TestCase
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post :create, doc: { description: @doc.description, doc_type_id: @doc.doc_type_id, name: @doc.name }
    end
  ...
  test "should update doc" do
    patch :update, id: @doc, doc: { description: @doc.description, doc_type_id: @doc.doc_type_id, name: @doc.name }
    assert_redirected_to doc_path(assigns(:doc))
  end
