...
class ClaimsControllerTest < ActionController::TestCase
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post :create, claim: { date: @claim.date, name: @claim.name, reached: @claim.reached, user_id: @claim.user_id }
    end
  ...
  test "should update claim" do
    patch :update, id: @claim, claim: { date: @claim.date, name: @claim.name, reached: @claim.reached, user_id: @claim.user_id }
    assert_redirected_to claim_path(assigns(:claim))
  end
