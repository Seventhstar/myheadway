...
class StatementsControllerTest < ActionController::TestCase
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post :create, statement: { author_id: @statement.author_id, content: @statement.content, source: @statement.source, theme: @statement.theme }
    end
  ...
  test "should update statement" do
    patch :update, id: @statement, statement: { author_id: @statement.author_id, content: @statement.content, source: @statement.source, theme: @statement.theme }
    assert_redirected_to statement_path(assigns(:statement))
  end
